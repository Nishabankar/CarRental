...
const Testimonial = () => {
    ...
    return (
        <div className="py-28 px-6 md:px-16 lg:px24 xl:px-44">
            ...
            <Title title="what Our Customers Say" subTitle="Discover why discerning travels choose StayVenture for their luxury accommodations around the world."/>
                ...
                <div key={index} className="bg-white p-6 rounded-xl shadow-lg hover:-translate-y-1 transition-all duration-500">
                    ...
                    <div className="flex items-center gap-1 mt-4">
                        {Array(5).fill(0).map((_, index) => (
                            <img kry={index} src={assets.star_icon} alt="star-icon"/>
                        ))}
                    </div>
